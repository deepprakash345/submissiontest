...
## Environments
- Preview: https://main--submissiontest--deepprakash345.hlx.page/
- Live: https://main--submissiontest--deepprakash345.hlx.live/
...
1. Open the `submissiontest` directory in your favorite IDE and start coding :)
